...
from Utils.Assets import set_volume
...
class SettingsFrame(NonGameFrame):
    ...
    def post_init(self, app):
        ...
        Label(("center", 40), "настройки", True, 36, (Config.screen_width, Config.screen_height), (255, 255, 255), (0, 0, 0), 1, self.buttons_group)

        Label((175, 120), "громкость_звуков", True, 22, (Config.screen_width, Config.screen_height), (255, 255, 255), (0, 0, 0), 1, self.buttons_group)
        ...
        Label((175, 230), "громкость_музыки", True, 22, (Config.screen_width, Config.screen_height), (255, 255, 255), (0, 0, 0), 1, self.buttons_group)
